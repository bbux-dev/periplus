...
- [x] 21-03-PLAN.md — Trip-only AppShell + router rewrite + remove listModes from activeMode
- [x] 21-04-PLAN.md — Atomic deletion of 11 pages + dead subsystem; final tsc/vitest green gate
...
- [x] 23-03-PLAN.md — ActivityFormPage at /activity/:type (Name/Location/Rating/Notes + Other free-text Type; stamped activity save) + route wiring
...
- [x] 24-03-PLAN.md — EditEntryModal + inline edit/delete on TripDetail timeline (RPT-05, RPT-06)
